  ...
  <div class="markdown-wrapper">
    ...
    <div class="copy-actions">
      <div class="copy-dropdown" :class="{ active: showCopyOptions }">
        <button @click="toggleCopyOptions" class="copy-btn">
        ...
        <div class="copy-options" v-show="showCopyOptions">
          <button @click="copyAsMarkdown" class="copy-option" style="padding-right: 0;">
          ...
          <button @click="copyAsHtml" class="copy-option" style="padding-right: 0;">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
            HTML
          </button>
          <button @click="copyAsText" class="copy-option" style="padding-right: 0;">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
